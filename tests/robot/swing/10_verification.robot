...
Element Should Be Visible By Name
    ...
    [Tags]    smoke    positive
    Element Should Be Visible    [name='loginBtn']
...
Element Should Be Visible For Different Components
    ...
    Element Should Be Visible    JLabel[text='Username:']
...
Element Should Be Enabled By Name
    ...
    [Tags]    smoke    positive
    Element Should Be Enabled    [name='loginBtn']
...
Get Element Text From Label
    ...
    [Tags]    smoke    positive
    ${text}=    Get Element Text    JLabel[text='Username:']
...
Get Element Text From Button
    ...
    [Tags]    positive
    ${text}=    Get Element Text    JButton[name='loginBtn']
    Should Not Be Empty    ${text}
...
Get Element Text From TextField
    ...
    [Tags]    positive
    Input Text    [name='username']    testtext
...
Element Text Should Be Exact Match
    ...
    [Tags]    smoke    positive
    Element Text Should Be    JLabel[text='Username:']    Username:
...
Element Text Should Be Using XPath
    ...
    [Tags]    positive    xpath-locator
    ${status}=    Run Keyword And Return Status
    ...    Element Text Should Be    //JButton[@name='loginBtn']    Login
...
Element Text Should Be For Button
    ...
    [Tags]    positive
    ${status}=    Run Keyword And Return Status
    ...    Element Text Should Be    JButton[name='clearBtn']    Clear
...
Element Text Should Contain Substring
    ...
    [Tags]    smoke    positive
    Element Text Should Contain    JLabel[text='Username:']    User
...
Element Text Should Contain Using XPath
    ...
    [Tags]    positive    xpath-locator
    ${status}=    Run Keyword And Return Status
    ...    Element Text Should Contain    //JButton[@name='loginBtn']    Log
    Log    XPath contains: ${status}

Element Text Should Contain Partial
    [Documentation]    Verify partial text match.
    [Tags]    positive
    Element Text Should Contain    JLabel[text='Username:']    name
...
Get All Element Properties Using ID
    ...
    [Tags]    positive
    ${props}=    Get Element Properties    \#loginBtn
    Log    Properties: ${props}
...
Verify After Input Workflow
    ...
    [Tags]    workflow
    Input Text    [name='username']    verifyuser
    ${text}=    Get Element Text    JTextField[name='username']
...
Element Text Should Be Fails For Wrong Text
    ...
    [Tags]    negative    error-handling
    ${status}=    Run Keyword And Return Status
    ...    Element Text Should Be    JLabel[text='Username:']    WrongText
    Should Be Equal    ${status}    ${FALSE}
...
Element Text Should Contain Fails For Missing Text
    ...
    [Tags]    negative    error-handling
    ${status}=    Run Keyword And Return Status
    ...    Element Text Should Contain    JLabel[text='Username:']    NonExistent
    Should Be Equal    ${status}    ${FALSE}
...
Element Should Not Exist Fails For Existing
    ...
    [Tags]    negative    error-handling
    ${status}=    Run Keyword And Return Status
    ...    Element Should Not Exist    JButton[name='loginBtn']
    Should Be Equal    ${status}    ${FALSE}
...
Verify All Form Elements
    ...
    Element Should Exist    JPasswordField[name='password']
    Element Should Exist    JButton[name='loginBtn']
    Element Should Exist    JButton[name='clearBtn']
    Element Should Be Enabled    JTextField[name='username']
    Element Should Be Enabled    JPasswordField[name='password']
    Element Should Be Enabled    JButton[name='loginBtn']
    Element Should Be Enabled    JButton[name='clearBtn']
